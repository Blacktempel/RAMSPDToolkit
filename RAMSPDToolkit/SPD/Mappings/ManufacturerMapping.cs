...
{
    /// <summary>
    /// Mapping for manufacturers according to JEDEC standard.<br/>
    /// Please note that this starts at Bank 1, not Bank 0.
    /// </summary>
    /// <remarks>Biggest part of this class is autogenerated via a python script.</remarks>
    public class ManufacturerMapping
    {
        /// <summary>
        /// Stores manufacturer banks beginning at Bank 1.<br/>
        /// Note: if you have, for example, number of continuation codes zero (0) you need to access Bank 1.
        /// </summary>
        public static readonly IReadOnlyDictionary<byte, Dictionary<byte, string>> ManufacturerBanks = new Dictionary<byte, Dictionary<byte, string>>
        {
            //JEP106BN - January 2026
            ...
            },
            {
                ...
                new Dictionary<byte, string>
                {
                    ...
                    { 0x8C, "Graychip" },
                    { 0x0D, "GENNUM" },
                    { 0x0E, "Imagination Technologies Limited" },
                    { 0x8F, "Robert Bosch" },
                    { 0x10, "Chip Express" },
                    { 0x91, "DATARAM" },
                    ...
                    { 0x29, "Vanguard" },
                    { 0x2A, "Hagiwara Solutions Co Ltd" },
                    { 0xAB, "Vantis" },
                    { 0x2C, "Celestica" },
                    { 0xAD, "Century" },
                    { 0xAE, "Hal Computers" },
                    ...
                    { 0xC4, "Transmeta" },
                    { 0x45, "Micron CMS" },
                    { 0x46, "American Computer Digital Components" },
            ...
            },
            {
                ...
                new Dictionary<byte, string>
                {
                    ...
                    { 0x51, "GigaDevice Semiconductor (Beijing)" },
            ...
            },
            {
                ...
                new Dictionary<byte, string>
                {
                    ...
                    { 0x19, "Phytium" },
                    { 0x1A, "UniIC Semiconductors Co Ltd" },
                    { 0x9B, "Ambiq Micro" },
            ...
            },
            {
                ...
                new Dictionary<byte, string>
                {
                    ...
                    { 0x68, "Shanghai Ruixuan Information Tech" },
                    { 0xE9, "Fraunhofer IIS" },
                    { 0xEA, "Kandou Bus SA" },
                    { 0x6B, "Acer" },
            ...
            },
            {
                ...
                new Dictionary<byte, string>
                {
                    ...
                    { 0xEA, "Kowin Technology HK Limited" },
            ...
            },
            {
                ...
                new Dictionary<byte, string>
                {
                    ...
                    { 0x62, "Wuxi Smart Memories Technologies Co" },
                    { 0xE3, "Star Memory" },
            ...
            },
            {
                ...
                new Dictionary<byte, string>
                {
                    ...
                    { 0x08, "ShenZhen ChaoYing ZhiNeng Technology" },
                    ...
                    { 0xB9, "AONDEVICES Inc" },
                    { 0xBA, "Shenzhen Netforward Micro Electronic" },
                    { 0x3B, "Syntacore Ltd" },
                    { 0xBC, "Shenzhen Secmem Microelectronics Co" },
                    { 0x3D, "ONiO As" },
                    { 0x3E, "Shenzhen Peladn Technology Co Ltd" },
                    { 0xBF, "O-Cubes Shanghai Microelectronics" },
                    { 0x40, "ASTC" },
                    { 0xC1, "UMIS" },
                    { 0xC2, "Paradromics" },
                    { 0x43, "Sinh Micro Co Ltd" },
                    { 0xC4, "Metorage Semiconductor Technology Co" },
                    { 0x45, "Aeva Inc" },
                    { 0x46, "HongKong Hyunion Electronics Co Ltd" },
                    { 0xC7, "China Flash Co Ltd" },
                    { 0xC8, "Sunplus Technology Co Ltd" },
                    { 0x49, "Idaho Scientific" },
                    { 0x4A, "Suzhou SF Micro Electronics Co Ltd" },
                    { 0xCB, "IMEX Cap AG" },
                    { 0x4C, "Fitipower Integrated  Technology Co Ltd" },
                    { 0xCD, "ShenzhenWooacme Technology Co Ltd" },
                    { 0xCE, "KeepData Original Chips" },
                    { 0x4F, "Rivos Inc" },
                    { 0xD0, "Big Innovation Company Limited" },
                    { 0x51, "Wuhan YuXin Semiconductor Co Ltd" },
                    { 0x52, "United Memory Technology (Jiangsu)" },
                    { 0xD3, "PQShield Ltd" },
                    { 0x54, "ArchiTek Corporation" },
                    { 0xD5, "ShenZhen AZW Technology Co Ltd" },
                    { 0xD6, "Hengchi Zhixin (Dongguan) Technology" },
                    { 0x57, "Eggtronic  Engineering Spa" },
                    { 0x58, "Fusontai Technology" },
                    { 0xD9, "PULP Platform" },
                    { 0xDA, "Koitek Electronic Technology (Shenzhen) Co" },
                    { 0x5B, "Shenzhen Jiteng Network Technology Co" },
                    { 0xDC, "Aviva Links Inc" },
                    { 0x5D, "Trilinear Technologies Inc" },
                    { 0x5E, "Shenzhen Developer Microelectronics Co" },
                    ...
                    { 0xE6, "Shenzhen Zhuqin Technology Co Ltd" },
                    { 0x67, "Shanghai Ningyuan Electronic Technology" },
                    { 0x68, "Auradine" },
                    { 0xE9, "Suzhou Yishuo Electronics Co Ltd" },
                    { 0xEA, "Faurecia Clarion Electronics" },
                    { 0x6B, "SiMa Technologies" },
                    { 0xEC, "CFD Sales Inc" },
                    { 0x6D, "Suzhou Comay Information Co Ltd" },
                    { 0x6E, "Yentek" },
                    { 0xEF, "Qorvo Inc" },
                    { 0x70, "Shenzhen Youzhi Computer Technology" },
                    { 0xF1, "Sychw Technology (Shenzhen) Co Ltd" },
                    { 0xF2, "MK Founder Technology Co Ltd" },
                    { 0x73, "Siliconwaves Technologies Co Ltd" },
                    { 0xF4, "Hongkong Hyunion Electronics Co Ltd" },
                    { 0x75, "Shenzhen Xinxinzhitao Electronics Business" },
                    { 0x76, "Shenzhen HenQi Electronic Commerce Co" },
                    { 0xF7, "Shenzhen Jingyi Technology Co Ltd" },
                    { 0xF8, "Xiaohua Semiconductor Co. Ltd." },
                    { 0x79, "Shenzhen Dalu Semiconductor Technology" },
                    { 0x7A, "Shenzhen Ninespeed Electronics Co Ltd" },
                    { 0xFB, "ICYC Semiconductor Co Ltd" },
                    { 0x7C, "Shenzhen Jaguar Microsystems Co Ltd" },
                    { 0xFD, "Beijing EC-Founder Co Ltd" },
                    { 0xFE, "Shenzhen Taike Industrial Automation Co" },
                }
            },
            {
                15, //Bank 15
                ...
                {
                    { 0x01, "Kalray SA" },
                    { 0x02, "Shanghai Iluvatar CoreX Semiconductor Co" },
                    { 0x83, "Fungible Inc" },
                    { 0x04, "Song Industria E Comercio de Eletronicos" },
                    { 0x85, "DreamBig Semiconductor Inc" },
                    { 0x86, "ChampTek Electronics Corp" },
                    { 0x07, "Fusontai Technology" },
                    { 0x08, "Endress Hauser AG" },
                    { 0x89, "altec ComputerSysteme GmbH" },
                    { 0x8A, "UltraRISC Technology (Shanghai) Co Ltd" },
                    { 0x0B, "Shenzhen Jing Da Kang Technology Co Ltd" },
                    { 0x8C, "Hangzhou Hongjun Microelectronics Co Ltd" },
                    { 0x0D, "Pliops Ltd" },
                    { 0x0E, "Cix Technology (Shanghai) Co Ltd" },
                    { 0x8F, "TeraDevices Inc" },
                    { 0x10, "SpacemiT (Hangzhou)Technology Co Ltd" },
                    { 0x91, "InnoPhase loT Inc" },
                    { 0x92, "InnoPhase loT Inc" },
                    { 0x13, "Yunhight Microelectronics" },
                    { 0x94, "Samnix" },
                    { 0x15, "HKC Storage Co Ltd" },
                    { 0x16, "Chiplego Technology (Shanghai) Co Ltd" },
                    { 0x97, "StoreSkill" },
                    { 0x98, "Shenzhen Astou Technology Company" },
                    { 0x19, "Guangdong LeapFive Technology Limited" },
                    { 0x1A, "Jin JuQuan" },
                    { 0x9B, "Huaxuan Technology (Shenzhen) Co Ltd" },
                    { 0x1C, "Gigastone Corporation" },
                    { 0x9D, "Kinsotin" },
                    { 0x9E, "PengYing" },
                    { 0x1F, "Shenzhen Xunhi Technology Co Ltd" },
                    { 0x20, "FOXX Storage Inc" },
                    { 0xA1, "Shanghai Belling Corporation Ltd" },
                    { 0xA2, "Glenfy Tech Co Ltd" },
                    { 0x23, "Sahasra Semiconductors Pvt Ltd" },
                    { 0xA4, "Chongqing SeekWave Technology Co Ltd" },
                    { 0x25, "Shenzhen Zhixing Intelligent Manufacturing" },
                    { 0x26, "Ethernovia" },
                    { 0xA7, "Shenzhen Xinrongda Technology Co Ltd" },
                    { 0xA8, "Hangzhou Clounix Technology Limited" },
                    { 0x29, "JGINYUE" },
                    { 0x2A, "Shenzhen Xinwei Semiconductor Co Ltd" },
                    { 0xAB, "COLORFIRE Technology Co Ltd" },
                    { 0x2C, "B LKE" },
                    { 0xAD, "ZHUDIAN" },
                    { 0xAE, "REECHO" },
                    { 0x2F, "Enphase Energy Inc" },
                    { 0xB0, "Shenzhen Yingrui Storage Technology Co Ltd" },
                    { 0x31, "Shenzhen Sinomos Semiconductor Technology" },
                    { 0x32, "O2micro International Limited" },
                    { 0xB3, "Axelera AI BV" },
                    { 0x34, "Silicon Legend Technology (Suzhou) Co Ltd" },
                    { 0xB5, "Suzhou Novosense Microelectronics Co Ltd" },
                    { 0xB6, "Pirateman" },
                    { 0x37, "Yangtze MasonSemi" },
                    { 0x38, "Shanghai Yunsilicon Technology Co Ltd" },
                    { 0xB9, "Rayson" },
                    { 0xBA, "Alphawave IP" },
                    { 0x3B, "Shenzhen Visions Chip Electronic Technology" },
                    { 0xBC, "KYO Group" },
                    { 0x3D, "Shenzhen Aboison Technology Co Ltd" },
                    { 0x3E, "Shenzhen JingSheng Semiconducto Co Ltd" },
                    { 0xBF, "Shenzhen Dingsheng Technology Co Ltd" },
                    { 0x40, "EVAS Intelligence Co Ltd" },
                    { 0xC1, "Kaibright Electronic Technologies" },
                    { 0xC2, "Fraunhofer IMS" },
                    { 0x43, "Shenzhen Xinrui Renhe Technology" },
                    { 0xC4, "Beijing Vcore Technology Co Ltd" },
                    { 0x45, "Silicon Innovation Technologies Co Ltd" },
                    { 0x46, "Shenzhen Zhengxinda Technology Co Ltd" },
                    { 0xC7, "Shenzhen Remai Electronics Co Lttd" },
                    { 0xC8, "Shenzhen Xinruiyan Electronics Co Ltd" },
                    { 0x49, "CEC Huada Electronic Design Co Ltd" },
                    { 0x4A, "Westberry Technology Inc" },
                    { 0xCB, "Tongxin Microelectronics Co Ltd" },
                    { 0x4C, "UNIM Semiconductor (Shang Hai) Co Ltd" },
                    { 0xCD, "Shenzhen Qiaowenxingyu Industrial Co Ltd" },
                    { 0xCE, "ICC" },
                    { 0x4F, "Enfabrica Corporation" },
                    { 0xD0, "Niobium Microsystems Inc" },
                    { 0x51, "Xiaoli AI Electronics (Shenzhen) Co Ltd" },
                    { 0x52, "Silicon Mitus" },
                    { 0xD3, "Ajiatek Inc" },
                    { 0x54, "HomeNet" },
                    { 0xD5, "Shenzhen Shubang Technology Co Ltd" },
                    { 0xD6, "Exacta Technologies Ltd" },
                    { 0x57, "Synology" },
                    { 0x58, "Trium Elektronik Bilgi Islem San Ve Dis" },
                    { 0xD9, "Wuxi HippStor Technology Co Ltd" },
                    { 0xDA, "SSCT" },
                    { 0x5B, "Sichuan Heentai Semiconductor Co Ltd" },
                    { 0xDC, "Zhejiang University" },
                    { 0x5D, "www.shingroup.cn" },
                    { 0x5E, "Suzhou Nano Mchip Technology Company" },
                    { 0xDF, "Feature Integration Technology Inc" },
                    { 0xE0, "d-Matrix" },
                    { 0x61, "Golden Memory" },
                    { 0x62, "Qingdao Thunderobot Technology Co Ltd" },
                    { 0xE3, "Shenzhen Tianxiang Chuangxin Technology" },
                    { 0x64, "HYPHY USA" },
                    { 0xE5, "Valkyrie" },
                    { 0xE6, "Suzhou Hesetc Electronic Technology Co" },
                    { 0x67, "Hainan Zhongyuncun Technology Co Ltd" },
                    { 0x68, "Shenzhen Yousheng Bona Technology Co" },
                    { 0xE9, "Shenzhen Xinle Chuang Technology Co" },
                    { 0xEA, "DEEPX" },
                    { 0x6B, "iStarChip CA LLC" },
                    { 0xEC, "Shenzhen Vinreada Technology Co Ltd" },
                    { 0x6D, "Novatek Microelectronics Corp" },
                    { 0x6E, "Chemgdu EG Technology Co Ltd" },
                    { 0xEF, "AGI Technology" },
                    { 0x70, "Syntiant" },
                    { 0xF1, "AOC" },
                    { 0xF2, "GamePP" },
                    { 0x73, "Yibai Electronic Technologies" },
                    { 0xF4, "Hangzhou Rencheng Trading Co Ltd" },
                    { 0x75, "HOGE Technology Co Ltd" },
                    { 0x76, "United Micro Technology (Shenzhen) Co" },
                    { 0xF7, "Fabric of Truth Inc" },
                    { 0xF8, "Elpitech" },
                    { 0x79, "Elitestek" },
                    { 0x7A, "Cornelis Networks Inc" },
                    { 0xFB, "WingSemi Technologies Co Ltd" },
                    { 0x7C, "ForwardEdge ASIC" },
                    { 0xFD, "Beijing Future Signet Technology Co Ltd" },
            ...
            },
            {
                ...
                new Dictionary<byte, string>
                {
                    ...
                    { 0x85, "NTT Innovative Devices Corporation" },
                    { 0x86, "Xbstor" },
                    { 0x07, "Shenzhen South Electron Co Ltd" },
                    { 0x08, "Iontra Inc" },
                    { 0x89, "SIEFFI Inc" },
                    { 0x8A, "HK Winston Electronics Co Limited" },
                    { 0x0B, "Anhui SunChip Semiconductor Technology" },
                    { 0x8C, "HaiLa Technologies Inc" },
                    { 0x0D, "AUTOTALKS" },
                    { 0x0E, "Shenzhen Ranshuo Technology Co Limited" },
                    { 0x8F, "ScaleFlux" },
                    { 0x10, "XC Memory" },
                    { 0x91, "Guangzhou Beimu Technology Co Ltd" },
                    { 0x92, "Rays Semiconductor Nanjing Co Ltd" },
                    { 0x13, "Milli-Centi Intelligence Technology Jiangsu" },
                    { 0x94, "Zilia Technologies" },
                    { 0x15, "Incore Semiconductors" },
                    { 0x16, "Kinetic Technologies" },
                    { 0x97, "Nanjing Houmo Technology Co Ltd" },
                    { 0x98, "Suzhou Yige Technology Co Ltd" },
                    { 0x19, "Shenzhen Techwinsemi Technology Co Ltd" },
                    { 0x1A, "Pure Array Technology (Shanghai) Co Ltd" },
                    { 0x9B, "Shenzhen Techwinsemi Technology Udstore" },
                    { 0x1C, "RISE MODE" },
                    { 0x9D, "NEWREESTAR" },
                    { 0x9E, "Hangzhou Hualan Microeletronique Co Ltd" },
                    { 0x1F, "Senscomm Semiconductor Co Ltd" },
                    { 0x20, "Holt Integrated Circuits" },
                    { 0xA1, "Tenstorrent Inc" },
                    { 0xA2, "SkyeChip" },
                    { 0x23, "Guangzhou Kaishile Trading Co Ltd" },
                    { 0xA4, "Jing Pai Digital Technology (Shenzhen) Co" },
                    { 0x25, "Memoritek" },
                    { 0x26, "Zhejiang Hikstor Technology Co Ltd" },
                    { 0xA7, "Memoritek PTE Ltd" },
                    { 0xA8, "Longsailing Semiconductor Co Ltd" },
                    { 0x29, "LX Semicon" },
                    { 0x2A, "Shenzhen Techwinsemi Technology Co Ltd" },
                    { 0xAB, "AOC" },
                    { 0x2C, "GOEPEL Electronic GmbH" },
                    { 0xAD, "Shenzhen G-Bong Technology Co Ltd" },
                    { 0xAE, "Openedges Technology Inc" },
                    { 0x2F, "EA Semi Shangahi Limited" },
                    { 0xB0, "EMBCORF" },
                    { 0x31, "Shenzhen MicroBT Electronics Technology" },
                    { 0x32, "Shanghai Simor Chip Semiconductor Co" },
                    { 0xB3, "Xllbyte" },
                    { 0x34, "Guangzhou Maidite Electronics Co Ltd." },
                    { 0xB5, "Zhejiang Changchun Technology Co Ltd" },
                    { 0xB6, "Beijing Cloud Security Technology Co Ltd" },
                    { 0x37, "SSTC Technology and Distribution Inc" },
                    { 0x38, "Shenzhen Panmin Technology Co Ltd" },
                    { 0xB9, "ITE Tech Inc" },
                    { 0xBA, "Beijing Zettastone Technology Co Ltd" },
                    { 0x3B, "Powerchip Micro Device" },
                    { 0xBC, "Shenzhen Ysemi Computing Co Ltd" },
                    { 0x3D, "Shenzhen Titan Micro Electronics Co Ltd" },
                    { 0x3E, "Shenzhen Macroflash Technology Co Ltd" },
                    { 0xBF, "Advantech Group" },
                    { 0x40, "Shenzhen Xingjiachen Electronics Co Ltd" },
                    { 0xC1, "CHUQI" },
                    { 0xC2, "Dongguan Liesun Trading Co Ltd" },
                    { 0x43, "Shenzhen Miuman Technology Co Ltd" },
                    { 0xC4, "Shenzhen Techwinsemi Technology Twsc" },
                    { 0x45, "Encharge AI Inc" },
                    { 0x46, "Shenzhen Zhenchuang Electronics Co Ltd" },
                    { 0xC7, "Giant Chip Co. Ltd" },
                    { 0xC8, "Shenzhen Runner Semiconductor Co Ltd" },
                    { 0x49, "Scalinx" },
                    { 0x4A, "Shenzhen Lanqi Electronics Co Ltd" },
                    { 0xCB, "CoreComm Technology Co Ltd" },
                    { 0x4C, "DLI Memory" },
                    { 0xCD, "Shenzhen Fidat Technology Co Ltd" },
                    { 0xCE, "Hubei  Yangtze Mason Semiconductor Tech" },
                    { 0x4F, "Flastor" },
                    { 0xD0, "PIRATEMAN" },
                    { 0x51, "Barrie Technologies Co Ltd" },
                    { 0x52, "Dynacard Co Ltd" },
                    { 0xD3, "Rivian Automotive" },
                    { 0x54, "Shenzhen Fidat Technology Co Ltd" },
                    { 0xD5, "Zhejang Weiming Semiconductor Co Ltd" },
                    { 0xD6, "Shenzhen Xinhua Micro Technology Co Ltd" },
                    { 0x57, "Duvonn Electronic Technology Co Ltd" },
                    { 0x58, "Shenzhen Xinchang Technology Co Ltd" },
                    { 0xD9, "Leidos" },
                    { 0xDA, "Keepixo" },
                    { 0x5B, "Applied Brain Research Inc" },
                    { 0xDC, "Maxio Technology (Hangzhou) Co Ltd" },
                    { 0x5D, "HK DCHIP Technology Limited" },
                    { 0x5E, "Hitachi-LG Data Storage" },
                    { 0xDF, "Shenzhen Huadian Communication Co Ltd" },
                    { 0xE0, "Achieve Memory Technology (Suzhou) Co" },
                    { 0x61, "Shenzhen Think Future Semiconductor Co" },
                    { 0x62, "Innosilicon" },
                    { 0xE3, "Shenzhen Weilida Technology Co Ltd" },
                    { 0x64, "Agrade Storage (Shenzhen) Co Ltd" },
                    { 0xE5, "Shenzhen Worldshine Data Technology Co" },
                    { 0xE6, "Mindgrove Technologies" },
                    { 0x67, "BYD Semiconductor Co Ltd" },
                    { 0x68, "Chipsine Semiconductor (Suzhou) Co Ltd" },
                    { 0xE9, "Shen Zhen Shi Xun He Shi Ji Dian Zi You" },
                    { 0xEA, "Shenzhen Jindacheng Computer Co Ltd" },
                    { 0x6B, "Shenzhen Baina Haichuan Technology Co" },
                    { 0xEC, "Shanghai Hengshi Electronic Technology" },
                    { 0x6D, "Beijing Boyu Tuxian Technology Co Ltd" },
                    { 0x6E, "China Chips Star Semiconductor Co Ltd" },
                    { 0xEF, "Shenzhen Shenghuacan Technology Co" },
                    { 0x70, "Kinara Inc" },
